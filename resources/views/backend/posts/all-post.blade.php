...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-12 title">
            <h1><i class="fa fa-bars"></i> Добавить новый пост <a href="{{ url('add-post') }}" class="btn btn-sm btn-default">Добавить пост</a></h1>
        </div>
        <div class="col-sm-12">
        ...
        <div class="search-div">
            <div class="col-sm-9">
                Все({{ $allPosts }}) | Опубликовано ({{$published}})
            </div>
        ...
        <form method="post" action="{{ url('multipledelete') }}">
            ...
            <div class="filter-div">
                ...
                <div class="col-sm-12 text-right">
                    {{ $posts->links('partials.admin-paginate') }}
                </div>
            </div>
                    ...
                    <table class="table table-striped" id="myTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$post->status }}</td>
                                <td><a href="{{ url('article') }}/{{ $post->slug }}">Посмотреть</td>
                                <td>{{ $post->created_at }}</td>
                            </tr>
                            @endforeach
                            @else
                            <tr>
                                <td calspan="4">Пост не найден</td>
                            </tr>
                            @endif
                        </tbody>
                    </table>
